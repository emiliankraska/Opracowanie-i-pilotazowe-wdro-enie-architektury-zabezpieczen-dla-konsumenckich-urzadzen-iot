 ...
 * Modified to issue GET to /test instead of PUT to /pcr_check.
 */
...
#define COAP_CLIENT_URI "coaps://10.204.29.130/test"
#endif
...
#define BUFSIZE 100
    ...
    dtls_pki.pki_key.key.define.private_key_def = COAP_PKI_KEY_DEF_PEM_BUF;
    ...
    pdu = coap_pdu_init(is_mcast ? COAP_MESSAGE_NON : COAP_MESSAGE_CON,
                        COAP_REQUEST_CODE_GET,   // GET request
